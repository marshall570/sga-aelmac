...
class Ui_FormFicha(object):
    ...
    def empty_form(self):
        ...
        if self.check_pasteur_a2.isChecked():
            self.check_pasteur_a2.toggle()
        if self.check_pasteur_a4.isChecked():
            self.check_pasteur_a4.toggle()
        if self.check_pasteur_12.isChecked():
            self.check_pasteur_12.toggle()
        if self.check_pasteur_a3.isChecked():
            self.check_pasteur_a3.toggle()
        if self.check_pasteur_3e3m.isChecked():
            self.check_pasteur_3e3m.toggle()
        if self.check_pasteur_p3f.isChecked():
            self.check_pasteur_p3f.toggle()
    ...
    def enable_read_only(self):
        ...
        self.check_pasteur_a2.setEnabled(False)
        self.check_pasteur_a4.setEnabled(False)  
        self.check_pasteur_12.setEnabled(False)        
        self.check_pasteur_a3.setEnabled(False)
        self.check_pasteur_3e3m.setEnabled(False)
        self.check_pasteur_p3f.setEnabled(False)
    ...
    def disable_read_only(self):
        ...
        self.check_pasteur_a2.setEnabled(True)
        self.check_pasteur_a4.setEnabled(True)  
        self.check_pasteur_12.setEnabled(True)        
        self.check_pasteur_a3.setEnabled(True)
        self.check_pasteur_3e3m.setEnabled(True)
        self.check_pasteur_p3f.setEnabled(True)
    ...
    def setupUi(self, FormFicha):
        ...
        window_icon.addPixmap(QtGui.QPixmap("images/aelmac_white.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        FormFicha.setWindowIcon(window_icon)
        FormFicha.setWindowFlags(QtCore.Qt.WindowTitleHint)        
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap("images/user_go.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.check_pasteur_a2 = QtWidgets.QCheckBox(self.groupBox_14)
        self.check_pasteur_a2.setGeometry(QtCore.QRect(20, 55, 101, 22))
        font = QtGui.QFont()
        font.setFamily("Ubuntu")
        font.setPixelSize(12)
        font.setBold(False)
        font.setWeight(50)
        self.check_pasteur_a2.setFont(font)
        self.check_pasteur_a2.setObjectName("check_pasteur_a2")
        self.check_pasteur_a4 = QtWidgets.QCheckBox(self.groupBox_14)
        self.check_pasteur_a4.setGeometry(QtCore.QRect(140, 55, 101, 22))
        font = QtGui.QFont()
        font.setFamily("Ubuntu")
        font.setPixelSize(12)
        font.setBold(False)
        font.setWeight(50)
        self.check_pasteur_a4.setFont(font)
        self.check_pasteur_a4.setObjectName("check_pasteur_a4")
        self.check_pasteur_12 = QtWidgets.QCheckBox(self.groupBox_14)
        self.check_pasteur_12.setGeometry(QtCore.QRect(260, 55, 111, 22))
        font = QtGui.QFont()
        font.setFamily("Ubuntu")
        font.setPixelSize(12)
        font.setBold(False)
        font.setWeight(50)
        self.check_pasteur_12.setFont(font)
        self.check_pasteur_12.setObjectName("check_pasteur_12")
        ...
        self.check_pasteur_a3 = QtWidgets.QCheckBox(self.groupBox_15)
        self.check_pasteur_a3.setGeometry(QtCore.QRect(50, 55, 101, 22))
        font = QtGui.QFont()
        font.setFamily("Ubuntu")
        font.setPixelSize(12)
        font.setBold(False)
        font.setWeight(50)
        self.check_pasteur_a3.setFont(font)
        self.check_pasteur_a3.setObjectName("check_pasteur_a3")
        self.check_pasteur_3e3m = QtWidgets.QCheckBox(self.groupBox_15)
        self.check_pasteur_3e3m.setGeometry(QtCore.QRect(210, 55, 131, 22))
        font = QtGui.QFont()
        font.setFamily("Ubuntu")
        font.setPixelSize(12)
        font.setBold(False)
        font.setWeight(50)
        self.check_pasteur_3e3m.setFont(font)
        self.check_pasteur_3e3m.setObjectName("check_pasteur_3e3m")
        ...
        self.check_pasteur_p3f = QtWidgets.QCheckBox(self.groupBox_16)
        self.check_pasteur_p3f.setGeometry(QtCore.QRect(120, 55, 141, 22))
        font = QtGui.QFont()
        font.setFamily("Ubuntu")
        font.setPixelSize(12)
        font.setBold(False)
        font.setWeight(50)
        self.check_pasteur_p3f.setFont(font)
        self.check_pasteur_p3f.setObjectName("check_pasteur_p3f")
    ...
    def retranslateUi(self, FormFicha):
        ...
        self.check_pasteur_a2.setText(_translate("FormFicha", "Pasteur - A2"))
        self.check_pasteur_a4.setText(_translate("FormFicha", "Pasteur - A4"))
        self.check_pasteur_12.setText(_translate("FormFicha", "Pasteur - 1/2"))
        self.groupBox_15.setTitle(_translate("FormFicha", "2) Domingo 2º, 3º, 4º ou 5º"))
        self.check_pasteur_a3.setText(_translate("FormFicha", "Pasteur - A3"))
        self.check_pasteur_3e3m.setText(_translate("FormFicha", "Pasteur - 3E, 3M"))
        self.groupBox_16.setTitle(_translate("FormFicha", "3) Sábado 1º"))
        self.check_pasteur_p3f.setText(_translate("FormFicha", "Pasteur - P3F  Cura"))
