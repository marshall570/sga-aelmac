...
class Ui_FormSignUp(object):
    ...
    def setupUi(self, FormSignUp):
        ...
        self.label_6.setGeometry(QtCore.QRect(10, 320, 181, 21))
        font = QtGui.QFont()
        font.setFamily("Ubuntu")
        font.setPointSize(12)
        font.setBold(True)
        ...
        self.btn_check.setGeometry(QtCore.QRect(170, 320, 21, 21))
        ...
        self.label_7.setGeometry(QtCore.QRect(10, 400, 111, 21))
        font = QtGui.QFont()
        font.setFamily("Ubuntu")
        font.setPointSize(12)
        font.setBold(True)
        ...
        self.btn_signup.setGeometry(QtCore.QRect(310, 490, 181, 34))
        font = QtGui.QFont()
        font.setFamily("Ubuntu")
