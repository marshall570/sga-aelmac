...
class Ui_FormFicha(object):
    ...
    def empty_form(self):
        ...
        self.btn_first_interview.setEnabled(False)
        self.btn_previous_interview.setEnabled(False)
        self.btn_next_interview.setEnabled(False)
        self.btn_last_interview.setEnabled(False)
    ...
    def setupUi(self, FormFicha):
        ...
        FormFicha.setMaximumSize(QtCore.QSize(900, 650))
        ...
        self.txt_phone1 = QtWidgets.QLineEdit(self.tab)
        ...
        self.txt_phone2 = QtWidgets.QLineEdit(self.tab)
        ...
        self.cmb_gender = QtWidgets.QComboBox(self.tab)
        ...
        self.cmb_civil_state = QtWidgets.QComboBox(self.tab)
        ...
        self.cmb_civil_state.addItem("")
        self.cmb_civil_state.addItem("")
        self.txt_ocupation = QtWidgets.QLineEdit(self.tab)
        ...
        self.txt_lives_with = QtWidgets.QLineEdit(self.tab)
        ...
        self.txt_neighbourhood = QtWidgets.QLineEdit(self.tab)
        ...
        self.txt_number = QtWidgets.QLineEdit(self.tab)
        ...
        self.txt_city = QtWidgets.QLineEdit(self.tab)
        ...
        self.cmb_state = QtWidgets.QComboBox(self.tab)
        ...
        self.radio_addiction_yes.toggled.connect(self.radio_addictions_yes_toggled)
        self.radio_addiction_no = QtWidgets.QRadioButton(self.groupBox_7)
        self.radio_addiction_no.setGeometry(QtCore.QRect(10, 60, 55, 22))
        font = QtGui.QFont()
        font.setFamily("Ubuntu")
        font.setPointSize(10)
        font.setBold(False)
        ...
        self.radio_addiction_no.toggled.connect(self.radio_addictions_no_toggled)
        self.check_alcohol = QtWidgets.QCheckBox(self.groupBox_7)
        self.check_alcohol.setGeometry(QtCore.QRect(80, 45, 75, 22))
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(False)
        font.setWeight(50)
        ...
        self.label_40.setGeometry(QtCore.QRect(10, 367, 111, 30))
        font = QtGui.QFont()
        font.setFamily("Ubuntu")
        font.setPointSize(11)
        font.setBold(True)
        ...
        self.cmb_feeding = QtWidgets.QComboBox(self.tab_2)
        ...
        self.txt_interview.setGeometry(QtCore.QRect(10, 100, 421, 191))
        self.txt_interview.setObjectName("txt_interview")
        self.txt_interview.setFont(font)
        self.btn_next_interview = QtWidgets.QPushButton(self.groupBox_11)
        self.btn_next_interview.setGeometry(QtCore.QRect(230, 340, 91, 34))
        font = QtGui.QFont()
        font.setPointSize(10)
        self.btn_next_interview.setFont(font)
        self.btn_next_interview.setLayoutDirection(QtCore.Qt.RightToLeft)
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap("images/resultset_next.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.btn_next_interview.setIcon(icon2)
        self.btn_next_interview.setObjectName("btn_next_interview")
        self.btn_last_interview = QtWidgets.QPushButton(self.groupBox_11)
        self.btn_last_interview.setGeometry(QtCore.QRect(340, 340, 91, 34))
        font = QtGui.QFont()
        font.setPointSize(10)
        self.btn_last_interview.setFont(font)
        self.btn_last_interview.setLayoutDirection(QtCore.Qt.RightToLeft)
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap("images/resultset_last.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.btn_last_interview.setIcon(icon3)
        self.btn_last_interview.setObjectName("btn_last_interview")
        self.btn_first_interview = QtWidgets.QPushButton(self.groupBox_11)
        self.btn_first_interview.setGeometry(QtCore.QRect(10, 340, 91, 34))
        font = QtGui.QFont()
        font.setPointSize(10)
        self.btn_first_interview.setFont(font)
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap("images/resultset_first.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.btn_first_interview.setIcon(icon4)
        self.btn_first_interview.setObjectName("btn_first_interview")
        self.btn_previous_interview = QtWidgets.QPushButton(self.groupBox_11)
        self.btn_previous_interview.setGeometry(QtCore.QRect(120, 340, 91, 34))
        font = QtGui.QFont()
        font.setPointSize(9)
        self.btn_previous_interview.setFont(font)
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap("images/resultset_previous.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.btn_previous_interview.setIcon(icon5)
        self.btn_previous_interview.setObjectName("btn_previous_interview")
        self.btn_new_interview = QtWidgets.QPushButton(self.groupBox_11)
        self.btn_new_interview.setGeometry(QtCore.QRect(10, 300, 200, 34))
        font = QtGui.QFont()
        font.setPointSize(10)
        self.btn_new_interview.setFont(font)
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap("images/pencil.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.btn_new_interview.setIcon(icon6)
        self.btn_new_interview.setObjectName("btn_new_interview")
        self.btn_save_interview = QtWidgets.QPushButton(self.groupBox_11)
        self.btn_save_interview.setGeometry(QtCore.QRect(230, 300, 200, 34))
        font = QtGui.QFont()
        font.setPointSize(10)
        self.btn_save_interview.setFont(font)
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap("images/disk.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.btn_save_interview.setIcon(icon6)
        self.btn_save_interview.setObjectName("btn_save_interview")
        self.groupBox_12 = QtWidgets.QGroupBox(self.tab_3)
        self.groupBox_12.setGeometry(QtCore.QRect(460, 10, 405, 221))
        font = QtGui.QFont()
        font.setFamily("Ubuntu")
        font.setPointSize(11)
        font.setBold(True)
        ...
        self.check_preparatory = QtWidgets.QCheckBox(self.groupBox_12)
        self.check_preparatory.setGeometry(QtCore.QRect(10, 30, 231, 22))
        font = QtGui.QFont()
        font.setFamily("Ubuntu")
        font.setPointSize(10)
        font.setBold(False)
        ...
        self.check_basic1 = QtWidgets.QCheckBox(self.groupBox_12)
        self.check_basic1.setGeometry(QtCore.QRect(10, 50, 231, 22))
        font = QtGui.QFont()
        font.setFamily("Ubuntu")
        font.setPointSize(10)
        font.setBold(False)
        ...
        self.check_basic2 = QtWidgets.QCheckBox(self.groupBox_12)
        self.check_basic2.setGeometry(QtCore.QRect(10, 70, 231, 22))
        font = QtGui.QFont()
        font.setFamily("Ubuntu")
        font.setPointSize(10)
        font.setBold(False)
        ...
        self.check_apprentice1 = QtWidgets.QCheckBox(self.groupBox_12)
        self.check_apprentice1.setGeometry(QtCore.QRect(10, 90, 231, 22))
        font = QtGui.QFont()
        font.setFamily("Ubuntu")
        font.setPointSize(10)
        font.setBold(False)
        ...
        self.check_apprentice2 = QtWidgets.QCheckBox(self.groupBox_12)
        self.check_apprentice2.setGeometry(QtCore.QRect(10, 110, 231, 22))
        font = QtGui.QFont()
        font.setFamily("Ubuntu")
        font.setPointSize(10)
        font.setBold(False)
        ...
        self.check_education1 = QtWidgets.QCheckBox(self.groupBox_12)
        self.check_education1.setGeometry(QtCore.QRect(10, 130, 231, 22))
        font = QtGui.QFont()
        font.setFamily("Ubuntu")
        font.setPointSize(10)
        font.setBold(False)
        ...
        self.check_education2 = QtWidgets.QCheckBox(self.groupBox_12)
        self.check_education2.setGeometry(QtCore.QRect(10, 150, 231, 22))
        font = QtGui.QFont()
        font.setFamily("Ubuntu")
        font.setPointSize(10)
        font.setBold(False)
        ...
        self.check_exposer = QtWidgets.QCheckBox(self.groupBox_12)
        self.check_exposer.setGeometry(QtCore.QRect(10, 170, 231, 22))
        font = QtGui.QFont()
        font.setFamily("Ubuntu")
        font.setPointSize(10)
        font.setBold(False)
        ...
        self.check_philosophy = QtWidgets.QCheckBox(self.groupBox_12)
        self.check_philosophy.setGeometry(QtCore.QRect(10, 190, 231, 22))
        font = QtGui.QFont()
        font.setFamily("Ubuntu")
        font.setPointSize(10)
        font.setBold(False)
        ...
        self.groupBox_13.setGeometry(QtCore.QRect(460, 240, 401, 155))
        font = QtGui.QFont()
        font.setFamily("Ubuntu")
        font.setPointSize(11)
        font.setBold(True)
        ...
        self.check_directors = QtWidgets.QCheckBox(self.groupBox_13)
        self.check_directors.setGeometry(QtCore.QRect(10, 30, 101, 22))
        font = QtGui.QFont()
        font.setFamily("Ubuntu")
        font.setPointSize(10)
        font.setBold(False)
        ...
        self.check_depass = QtWidgets.QCheckBox(self.groupBox_13)
        self.check_depass.setGeometry(QtCore.QRect(10, 60, 101, 22))
        font = QtGui.QFont()
        font.setFamily("Ubuntu")
        font.setPointSize(10)
        font.setBold(False)
        ...
        self.check_social_assistant = QtWidgets.QCheckBox(self.groupBox_13)
        self.check_social_assistant.setGeometry(QtCore.QRect(10, 90, 131, 22))
        font = QtGui.QFont()
        font.setFamily("Ubuntu")
        font.setPointSize(10)
        font.setBold(False)
        ...
        self.check_teaching = QtWidgets.QCheckBox(self.groupBox_13)
        self.check_teaching.setGeometry(QtCore.QRect(10, 120, 131, 22))
        font = QtGui.QFont()
        font.setFamily("Ubuntu")
        font.setPointSize(10)
        font.setBold(False)
        ...
        font.setPointSize(10)
        font.setWeight(50)
        self.txt_fowarding = QtWidgets.QTextEdit(self.groupBox_13)
        self.txt_fowarding.setGeometry(QtCore.QRect(109, 30, 281, 111))
        self.txt_fowarding.setObjectName("txt_fowarding")
        self.txt_fowarding.setFont(font)
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap("images/overlays.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap("images/lightbulb.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon10 = QtGui.QIcon()
        icon10.addPixmap(QtGui.QPixmap("images/disk.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon11 = QtGui.QIcon()
        icon11.addPixmap(QtGui.QPixmap("images/cancel.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        font.setWeight(75)
        icon18 = QtGui.QIcon()
        icon18.addPixmap(QtGui.QPixmap("images/pencil.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon14 = QtGui.QIcon()
        icon14.addPixmap(QtGui.QPixmap("images/database_save.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.btn_backups.setIcon(icon14)
        ...
        icon15 = QtGui.QIcon()
        icon15.addPixmap(QtGui.QPixmap("images/report.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.btn_report.setIcon(icon15)
        ...
        icon16 = QtGui.QIcon()
        icon16.addPixmap(QtGui.QPixmap("images/door_out.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.btn_log_out.setIcon(icon16)
        ...
        icon17 = QtGui.QIcon()
        icon17.addPixmap(QtGui.QPixmap("images/zoom.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.btn_search_index.setIcon(icon17)
    ...
    def retranslateUi(self, FormFicha):
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab), _translate("FormFicha", "Dados Pessoais"))
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_2), _translate("FormFicha", "Informações Extras"))
        self.groupBox_11.setTitle(_translate("FormFicha", "ENTREVISTAS"))
        ...
        self.btn_next_interview.setText(_translate("FormFicha", "PRÓXIMO"))
        self.btn_last_interview.setText(_translate("FormFicha", "ÚLTIMO"))
        self.btn_first_interview.setText(_translate("FormFicha", "PRIMEIRO"))
        self.btn_previous_interview.setText(_translate("FormFicha", "ANTERIOR"))
        self.btn_new_interview.setText(_translate("FormFicha", "NOVA ENTREVISTA"))
        self.btn_save_interview.setText(_translate("FormFicha", "SALVAR ENTREVISTA"))
        self.groupBox_12.setTitle(_translate("FormFicha", "FREQUÊNCIA"))
        ...
        self.groupBox_13.setTitle(_translate("FormFicha", "PREENCHIMENTO DO ENTREVISTADOR"))
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_3), _translate("FormFicha", "Entrevistas"))
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_4), _translate("FormFicha", "Colegiado"))
        ...
        self.txt_index.setText(_translate("FormFicha", "Digite um índice para ir até ele"))
